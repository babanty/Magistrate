...
{
    public partial class Article1226p1_NotAppeared : Form
    {
        public Article1226p1_NotAppeared()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Сгенерировать ворд
            GenerationWord.GenerateWord(Application.StartupPath + "\\Sample", "ст.12.26 ч.1 не явился", controlArrayToString);
        }
    }
}
